                     ...
                     )
{
    ...
    Eigen::Matrix<ScalarType, Eigen::Dynamic, Eigen::Dynamic> V;
    Eigen::MatrixXd Vd;
    Eigen::MatrixXi F;
    Eigen::VectorXi b;
    Eigen::MatrixXd bc;
    ...
    if(nFixed==0){// no selected vertices
        cout<<"no fixed vertices were selected in the parameterization"<<endl;
        return;
    }
